const features = [
  ...
  },
  {
    ...
    desc: 'Personalized product and content recommendations that increase conversion rates by up to 35%.',
  },
  {
    icon: '🎙️',
    title: 'AI Voice Assistant',
    desc: 'Query your business data hands-free. Ask questions in plain English and get instant spoken insights.',
  },
  {
    icon: '🖥️',
    title: 'Business Dashboard',
    desc: 'A unified command center for all your metrics — sales, marketing, ops — in one beautiful interface.',
  },
  {
    icon: '🔗',
    title: 'Seamless Integrations',
    desc: 'Connect to 200+ tools including Salesforce, Shopify, HubSpot, and your own APIs in minutes.',
  },
]
