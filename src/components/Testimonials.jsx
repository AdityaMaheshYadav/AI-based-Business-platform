const testimonials = [
  {
    ...
    color: 'bg-pink-500',
    quote:
      'NexusAI cut our customer churn by 40% in the first quarter. The prediction engine flagged at-risk accounts we never would have caught manually.',
    rating: 5,
  },
  {
    ...
    color: 'bg-blue-500',
    quote:
      'The AI voice assistant alone saves my team hours every week. I just ask "What drove last week\'s dip?" and get a full breakdown instantly.',
    rating: 5,
  },
  {
    name: 'Priya Nair',
    ...
    quote:
      'We replaced three separate BI tools with NexusAI. The unified dashboard and recommendation engine paid for itself in two months.',
    rating: 5,
  },
]
